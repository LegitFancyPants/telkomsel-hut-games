        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6 pb-6 border-b border-slate-200">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="px-3.5 py-2 rounded-xl border bg-white border-slate-200 hover:bg-slate-100 text-slate-800 text-xs font-bold flex items-center gap-1.5 transition-all shadow-sm"
            >
            ...
            <button
              ...
              className={`px-3.5 py-2 rounded-xl border text-xs font-extrabold flex items-center gap-1.5 transition-all shadow-sm ${
                isFullscreen
                  ? "bg-red-600 border-red-600 hover:bg-red-700 text-white shadow-md shadow-red-600/20"
